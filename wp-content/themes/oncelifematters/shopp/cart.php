...
<table class="cart">
	<tr>
		<th scope="col" class="item bb">Cart Items</th>
		<th scope="col" class="bb">Quantity</th>
		<th scope="col" class="money bb">Item Price</th>
		<th scope="col" class="money bb">Item Total</th>
	</tr>
	<?php while(shopp('cart','items')): ?>
		<tr>
			...
			<td class="bb"><?php shopp('cartitem','quantity','input=text'); ?>
				<?php shopp('cartitem','remove','input=button'); ?></td>
			<td class="money bb"><?php shopp('cartitem','unitprice'); ?></td>
			<td class="money bb"><?php shopp('cartitem','total'); ?></td>
		</tr>
	<?php endwhile; ?>
	...
	<a href="<?php shopp('cart','referrer'); ?>" class="super-link right">Continue Shopping</a>
	<a href="<?php shopp('checkout','url'); ?>" class="super-link right">Proceed to Checkout</a>
